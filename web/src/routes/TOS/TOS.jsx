		...
		<div className='tos-container'>
			...
			<div>
				...
				<div>
					<ul>
						<li>
							If a user violates any of the terms outlined below,
							we reserve the right to cancel accounts or bar
							access to accounts without notice. If you do not
						...
						<li>
							...
							use the Service after any such modifications have
							been made, this shall constitute your agreement to
							such modifications.
						</li>
						<li>
